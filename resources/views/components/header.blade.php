<header class="py-3 sticky top-0 z-10 lg:static bg-primary-50 dark:bg-primary-950">
  <div class="flex justify-between items-center px-5 lx:px-10 2xl:px-18 lg:hidden">
    ...
    <div class="relative flex justify-center items-center gap-2">
      <span class="absolute top-[50%] left-0 translate-x-[-125%] translate-y-[-50%]">@include('icons.globe')</span>
