...
<div class="radio-group flex justify-start items-center hover:cursor-pointer {{ $groupClass }}">
    ...
    ">
        <div class="w-full h-full rounded-full scale-0 transition group-has-checked/radio:scale-90 bg-primary-400 group-has-checked/radio:bg-secondary-600 group-has-checked/radio:dark:bg-secondary-400">
        </div>
    </div>
